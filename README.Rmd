...
This is a basic example which shows you how how one of the functions works:
...
To get around this, simple add `.sample` at the end of the filename: `pre-commit.sample`. Now it will be ignored by GitHub. 
